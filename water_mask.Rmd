...
for (rgn in regions){
  ...
  tif_m_12km = sprintf('P:/habitats/%s-12km_mask.tif'   , rgn)
  tif_p_12km = sprintf('P:/habitats/%s-12km_patchid.tif', rgn)
  ...
  r_m_12km = aggregate(r_m, fact_12km)
  writeRaster(r_m_12km, tif_m_12km, dataType ='INT1U', overwrite=T) 
  
  # generate patch IDs raster
  r_p_12km = setValues(r_m_12km, 1:ncell(r_m_12km)) %>%
    mask(r_m_12km)
  writeRaster(r_p_12km, tif_p_12km, dataType ='INT4S', overwrite=T)
