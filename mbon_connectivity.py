...
# Start > Run > cmd
#   H: & cd H:\MBON & C:\Python27\ArcGIS10.3\python.exe run_sp.py runs_todo.csv
# ---------------------------------------------------------------------------
...
# get input arguments
runs_csv = sys.argv[1] # "P:\\runs\\runs_todo.csv"
...
for run in runs:
 ...
 # set species-specific paths
	...
	arcpy.LarvalDispersalCreateSimulationFromArcGISRasters_GeoEco(simulation_dir, reefid_tif, pctcover_tif, watermask_tif, "false")
	...
	arcpy.LarvalDispersalLoadHYCOMGLBa0084DEquatorialCurrentsIntoSimulation_GeoEco(simulation_dir, "startDate", "endDate", "0", "false", "Meters", "false", "CUBIC", "Del2a", "60", "120", "cache_dir")
	...
	arcpy.LarvalDispersalRunSimulation2012_GeoEco(simulation_dir, results_dir, startDate, "durationDays", "1", "24", "", "", "0.8", "false", "", "", "", "50")
	...
	arcpy.LarvalDispersalVisualizeResults2012_GeoEco(simulation_dir, results_dir, "output.gdb", "", "A", "true", "0.00001", "false", "true", "0.00001", "Quantity")
