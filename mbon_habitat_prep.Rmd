...
```{r}
r = raster(tif_all)
se_buf = readOGR('H:/MBON/study_area.gdb', 'southeast_buf_mol')
tif_se = file.path(dir_hab, 'hab_id_se.tif')

r_se_buf = rasterize(se_buf, r)
r_se_buf_t = trim(r_se_buf)
...
r_se = crop(r, se_buf)
writeRaster(r_se, tif_se, overwrite=T)
